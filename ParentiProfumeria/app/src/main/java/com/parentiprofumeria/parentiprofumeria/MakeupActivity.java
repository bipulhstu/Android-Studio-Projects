            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                switch (menuItem.getItemId()){
                    case R.id.aboutUsBottomMenuId:
                        ...
                        startActivity(new Intent(MakeupActivity.this, AboutUsActivity.class));
                        customType(MakeupActivity.this,"left-to-right");
                        break;

                    case R.id.contactUsButtomMenuId:
                        menuItem.setChecked(true);
                        startActivity(new Intent(MakeupActivity.this, ContactUsActivity.class));
                        customType(MakeupActivity.this,"left-to-right");
                        break;
                    case R.id.notificationBottomMenuId:
                        menuItem.setChecked(true);
                        startActivity(new Intent(MakeupActivity.this, NotificationActivity.class));
                        customType(MakeupActivity.this,"left-to-right");
                        break;
                }
                return false;
